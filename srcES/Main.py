...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        pixmap = QPixmap('peachpeachlogo.png')
        ...
        settingButton.setIcon(QIcon('gear.png'))
        #추후에 수정하기
        ...
        menuButton.setIcon(QIcon('plusbutton.png'))
        ...
        searchButton.setIcon(QIcon('magnifying-glass.png'))
